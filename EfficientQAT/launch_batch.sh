...
# )
config_files=(
    /home/ubuntu/data/exp/proj2410/EfficientQAT/yaml/qwen2.5-0.5b-b2gs128-fast-gradual-quant-slide2.yaml
    /home/ubuntu/data/exp/proj2410/EfficientQAT/yaml/qwen2.5-0.5b-b2gs128-fast-gradual-quant-slide2-end2start.yaml
)
