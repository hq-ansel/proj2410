...
def train_units_layers(model: PreTrainedModel,
    ...
    qlayers[align_index]  = Catcher(
        qlayers[align_index])
    fp_layers[align_index] = Catcher(
        fp_layers[align_index])
    ...
    for layer_idx in trainable_layer_idx_list:
        ...
        if args.real_quant:
            ...
            for name, module in named_linears.items():
                ...
                del module
    # remove catcher layer
    model.model.layers[align_index]=qlayers[align_index].module
    target_model.model.layers[align_index]=fp_layers[align_index].module
