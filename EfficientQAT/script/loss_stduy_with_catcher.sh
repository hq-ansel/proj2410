...
# )
config_files=(
    /home/ubuntu/data/exp/proj2410/EfficientQAT/yaml/qwen2.5-0.5b/regular-loss-study/qwen2.5-0.5b-b2gs128-dampenloss.yaml
    # /home/ubuntu/data/exp/proj2410/EfficientQAT/yaml/qwen2.5-0.5b/regular-loss-study/qwen2.5-0.5b-b2gs128.yaml
)
