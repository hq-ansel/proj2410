...
@torch.library.register_fake("aqlm::code1x16_matmat")
...
@torch.library.register_fake("aqlm::code1x16_matmat_dequant")
...
@torch.library.register_fake("aqlm::code1x16_matmat_dequant_transposed")
...
@torch.library.register_fake("aqlm::code2x8_matmat")
...
@torch.library.register_fake("aqlm::code2x8_matmat_dequant")
...
@torch.library.register_fake("aqlm::code2x8_matmat_dequant_transposed")
